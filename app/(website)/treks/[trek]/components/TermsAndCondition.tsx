    ...
    <section className="my-8">
      ...
      <details className="p-8 rounded-md shadow-none bg-background">
        <summary className="flex items-center gap-4">
          ...
          <h6 className="text-base md:text-xl">Booking & Payment</h6>
        </summary>
        <hr className="border-gray-200 my-2" />
        <p className="text-sm md:text-base text-secondary my-0.5 font-normal">
      ...
      <details className="p-8 rounded-md shadow-none bg-background">
        <summary className="flex items-center gap-4">
          ...
          <h6 className="text-base md:text-xl">Cancellation Policy</h6>
        </summary>
        <hr className="border-gray-200 my-2" />
        <p className="text-sm md:text-base text-secondary my-0.5 font-normal">
        ...
        <p className="text-sm md:text-base text-secondary my-0.5 font-normal">
          4. <b className="text-black font-semibold">No Show:</b> No refund will
