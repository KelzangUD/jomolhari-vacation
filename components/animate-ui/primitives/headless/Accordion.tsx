...
function AccordionButton({
  ...
  return (
    <DisclosureButtonPrimitive
      className={cn(
        "focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-start justify-between gap-4 w-full rounded-md py-4 text-left text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-xl font-medium transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&[data-open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
